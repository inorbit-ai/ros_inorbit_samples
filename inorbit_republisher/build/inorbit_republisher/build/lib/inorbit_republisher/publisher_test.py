...
class TestRepublisher:
    ...
    def test_republish_message(self):
        ...
        test_msg = String()
        test_msg.data = 'Work all night on a drink of rum '
        ...
        assert self.received_message == 'Work all night on a drink of rum', \
            f"Expected 'Work all night on a drink of rum', but got {self.received_message}"
